  ...
  describe('[T1.1] _join', () => {
    ...
    describe('[T1.2] _leave', () => {
      describe('when the player is in the game', () => {
        ...
        describe('when the game is not in progress it should remove the player', () => {
          ...
          /* test('when someone has won the game, winner leaves', () => {
            const player1 = createPlayerForTesting();
            const player2 = createPlayerForTesting();
            ...
            expect(game.state.status).toEqual('OVER');
            expect(game.state.winner).toEqual(player1.id);
            expect(game.state.x).toBe(player1.d);
            expect(game.state.o).toBe(player2.id);
          }); */
        });
      });
    ...
    describe('applyMove', () => {
      ...
      describe('when given an invalid move', () => {
        ...
        /* it('should stop a player from going twice in a row (player x)', () => {
          game.join(player2);
        ...
        it('should stop a player from going twice in a row (player o)', () => {
          game.join(player2);
          ...
          const move1: TicTacToeMove = { row: 0, col: 2, gamePiece: 'X' };
          const move2: TicTacToeMove = { row: 0, col: 1, gamePiece: 'O' };
          const move3: TicTacToeMove = { row: 1, col: 1, gamePiece: 'O' };
        ...
        it('should check that the space is occupied (O moves)', () => {
          game.join(player2);
        ...
        it('should check that the space is occupied (X moves)', () => {
          game.join(player2);
